...
如果您在使用SVGO时遇到类似于`Error in parsing SVG: Unquoted attribute value`的报错，那么您很可能在SVG图像中有未加引号的属性。你可以在[这里](https://github.com/Klathmon/imagemin-webpack-plugin/issues/25)找到一个解决方案。他们还汇报了一个问题，在[这里](https://github.com/svg/svgo/issues/678)
